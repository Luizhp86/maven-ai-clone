  ...
  const caseStudies = [
    {
      ...
      description:
        "A Wittel Comunicações é uma empresa especializada em Customer Experience (CX), oferecendo soluções que otimizam o relacionamento entre marcas e consumidores.",
      url: "/casewittel",
    },
    {
      id: "tecfil",
      ...
      description:
        "A TECFIL é uma fábrica que produz filtros de ar para automóveis, oferecendo uma vasta gama de produtos para atender às necessidades do mercado automotivo.",
      url: "/casetecfil",
    },
    {
      id: "natacha",
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {caseStudies.map((caseStudy) => (
            <Card
              key={caseStudy.id}
              className="shadow-lg hover:shadow-xl transition-shadow overflow-hidden border border-gray-100"
            >
