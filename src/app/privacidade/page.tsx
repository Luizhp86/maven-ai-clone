      ...
      <div className="container">
        <div className="max-w-3xl mx-auto">
          ...
          <div className="prose prose-blue max-w-none">
            ...
            <p className="mb-4">
              A Automatizando Ltda. ("nós", "nos" ou "nosso") se compromete a
            ...
            <p className="mb-4">
              Por favor, leia esta política com atenção para entender nossas
              práticas em relação a seus dados pessoais.
            </p>
            ...
            <ul className="list-disc pl-6 mb-6">
              <li className="mb-2">
                <strong>Informações Pessoais:</strong> Nome, email, número de
                telefone, empresa e outras informações que você nos fornece
                voluntariamente através de formulários de contato ou ao se
                inscrever em nossa newsletter.
              </li>
              <li className="mb-2">
                <strong>Informações de Uso:</strong> Dados sobre como você
                interage com nosso site, incluindo páginas visitadas, tempo
                gasto no site, links clicados e outras ações realizadas durante
                o uso de nossos serviços.
              </li>
              <li className="mb-2">
                <strong>Cookies e Tecnologias Similares:</strong> Usamos cookies
                e tecnologias similares para melhorar a experiência do usuário e
                coletar informações sobre como nosso site é utilizado.
              </li>
            </ul>
            ...
            <ul className="list-disc pl-6 mb-6">
              ...
              <li className="mb-2">
                Processar e responder às suas solicitações e consultas;
              </li>
              <li className="mb-2">
                Enviar informações, atualizações e materiais de marketing sobre
                nossos serviços;
              </li>
              <li className="mb-2">
              ...
              <li className="mb-2">
                Analisar tendências e estatísticas para melhorar nossos
                serviços;
              </li>
              <li className="mb-2">
            ...
            <ul className="list-disc pl-6 mb-6">
              <li className="mb-2">
                Com fornecedores de serviços que nos ajudam a operar nosso
                negócio;
              </li>
              <li className="mb-2">
              ...
              <li className="mb-2">
                Com seu consentimento ou sob sua direção.
              </li>
            </ul>
            ...
            <ul className="list-disc pl-6 mb-6">
              ...
              <li className="mb-2">
                Direito de solicitar limitação do processamento;
              </li>
            ...
            <p className="mb-4">
              ...
              ciente de quaisquer alterações. A data da última atualização
