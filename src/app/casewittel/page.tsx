    ...
    <div>
      <div className="relative">
        <div
          ...
          style={{
            backgroundImage: "url('https://ext.same-assets.com/884131591/2122285897.jpeg')",
        ...
        <div className="container">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 text-white">
            <div className="flex flex-col items-center text-center">
              ...
              <p className="text-lg opacity-90">Redução do tempo de agendamentos e reuniões</p>
            </div>
            <div className="flex flex-col items-center text-center">
              <div className="text-5xl font-bold mb-2">+10%</div>
              <p className="text-lg opacity-90">Melhoria na eficiência operacional e na experiência do cliente</p>
            </div>
          </div>
        </div>
      </div>
          ...
          <div className="max-w-3xl mx-auto">
            ...
            <ul className="space-y-6">
              <li className="flex gap-4">
                ...
                <div>
                  <strong className="font-bold">Agendamento automatizado</strong> de reuniões de vendas, permitindo que os leads escolhessem horários convenientes.
                </div>
              </li>
              <li className="flex gap-4">
                <div className="w-6 h-6 rounded-full bg-maven-blue flex items-center justify-center text-white flex-shrink-0">•</div>
                <div>
                  <strong className="font-bold">Envio automático de lembretes</strong> pré-chamada, reduzindo a taxa de no-show ao manter os leads engajados e informados.
                </div>
              </li>
              <li className="flex gap-4">
                <div className="w-6 h-6 rounded-full bg-maven-blue flex items-center justify-center text-white flex-shrink-0">•</div>
                <div>
                  <strong className="font-bold">Pesquisas NPS automatizadas</strong> pós-reunião, facilitando a coleta de feedback valioso para otimizar a experiência de vendas.
                </div>
              </li>
            </ul>
          </div>
          ...
          <div className="max-w-3xl mx-auto">
            ...
            <ul className="space-y-6">
              <li className="flex gap-4">
                <div className="w-6 h-6 rounded-full bg-maven-blue flex items-center justify-center text-white flex-shrink-0">•</div>
                <div>
                  <strong className="font-bold">Aumento de 70% na taxa de comparecimento</strong> às reuniões de vendas, impulsionado pelos lembretes personalizados.
                </div>
              </li>
              <li className="flex gap-4">
                <div className="w-6 h-6 rounded-full bg-maven-blue flex items-center justify-center text-white flex-shrink-0">•</div>
                <div>
                  <strong className="font-bold">85% de taxa de resposta nas pesquisas NPS</strong>, permitindo insights valiosos que aprimoraram a abordagem de vendas.
                </div>
              </li>
              <li className="flex gap-4">
                <div className="w-6 h-6 rounded-full bg-maven-blue flex items-center justify-center text-white flex-shrink-0">•</div>
                <div>
                  <strong className="font-bold">Redução de 50% no tempo de agendamento</strong>, tornando o processo mais ágil e eficiente.
                </div>
              </li>
              <li className="flex gap-4">
                <div className="w-6 h-6 rounded-full bg-maven-blue flex items-center justify-center text-white flex-shrink-0">•</div>
                <div>
                  <strong className="font-bold">Experiência do cliente aprimorada</strong>, com um fluxo mais autônomo e otimizado desde o agendamento até o feedback final.
                </div>
              </li>
            </ul>
          </div>
